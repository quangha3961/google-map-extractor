...
def clean_phone_number(phone):
    ...
    # Validate length (should be 10-11 digits for US numbers)
...
def update_excel_with_contact_info():
    ...
    try:
        ...
        # Đảm bảo cột Phone và Email có kiểu dữ liệu string
        ...
        # Hiển thị thống kê
        phones_found = (df['Phone'] != '').sum()
        emails_found = (df['Email'] != '').sum()
